...
class QualificationTableFormatterTest {
    ...
    QualificationTableFormatter formatter = new QualificationTableFormatter();
    DataReader dataReader = new DataReader();

    @Test
    void format_shouldReturnFormattedStringFromListOfRacers() {
        List<Racer> racers = dataReader.getRacers();

        String actualString = formatter.format(racers);
